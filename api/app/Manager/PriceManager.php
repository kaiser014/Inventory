...
class PriceManager{
    ...
    public static function calculate_sell_price($price, $discount_percent, $discount_fixed, $discount_start, $discount_end){
    ...
    private static function calculate_price($price, $discount_percent, $discount_fixed){
