...
const EditSalesManager = () => {
  ...
  const getSalesManager = () => {
    axios.get(`sales-manager/${params.id}`).then((res) => {
  ...
  const handleSalesManagerUpdate = () => {
    setIsLoading(true);
    axios
      .put(`sales-manager/${params.id}`, input)
      .then((res) => {
        setIsLoading(false);
        Swal.fire({
          position: "top-end",
                ...
                <div className="col-md-12 mt-3">
                  <div className="text-center">
                    <button
                      ...
                      onClick={handleSalesManagerUpdate}
